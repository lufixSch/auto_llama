...
<div class="flex flex-auto h-full">
	<menu
		class={cn(
			'h-full mt-11 md:mt-0 z-10 bg-zinc-50 dark:bg-zinc-950 w-full sm:w-1/4 sm:min-w-64 sm:border-r-[1px] border-zinc-200 dark:border-zinc-800 absolute md:static transition-transform',
			{
	...
	<div class="flex flex-col h-full w-full">
		...
		>
			...
			<h6 class="m-0"><a href="/character">Character</a></h6>
			<div class="w-full"></div>
