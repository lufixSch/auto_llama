...
>
	...
	<div class="flex space-x-2">
		<button class="w-full group" type="submit" disabled={required && !message}>
			...
			>
				<svg
					class="w-[36px] h-[36px] p-[8px] fill-black dark:fill-white group-disabled:fill-zinc-300 group-disabled:dark:fill-zinc-600"
		...
		<button class="w-full" type="button" on:click={handleSpecialAction}>
			{#if isGenerating}
				...
				>
					<svg
						class="w-[36px] h-[36px] p-[8px] fill-black dark:fill-white"
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 384 512"
						><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path
